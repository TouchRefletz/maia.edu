            ...
            fatores: {
              ...
              properties: {
                ...
                vocabulario_complexo: {
                  type: 'boolean',
                  description: 'Termos arcaicos, técnicos densos ou outra língua.',
                },
                multiplas_fontes_leitura: {
                  type: 'boolean',
                  description: 'Exige cruzar dados de Texto 1 x Texto 2 ou Texto x Gráfico.',
                },
                ...
                interdisciplinaridade: {
                  type: 'boolean',
                  description: 'Envolve conceitos de duas disciplinas distintas.',
                },
                contexto_abstrato: {
                  type: 'boolean',
                  description:
                ...
                abstracao_teorica: {
                  type: 'boolean',
                  description: 'Conceitos puramente teóricos sem representação física direta.',
                },
                deducao_logica: {
                  type: 'boolean',
                  description:
                ...
                resolucao_multiplas_etapas: {
                  type: 'boolean',
                  description: 'Passo A leva a Passo B que leva a Passo C (cálculo ou lógica).',
                },
                ...
                distratores_semanticos: {
                  type: 'boolean',
                  description: 'Alternativas erradas muito parecidas com a correta (pegadinhas).',
                },
                analise_nuance_julgamento: {
                  type: 'boolean',
                  description: "Exige escolher a 'mais correta' dentre opções plausíveis.",
                },
              },
              required: [
                'texto_extenso',
          ...
          items: {
            ...
            properties: {
              ...
              conteudo: {
                type: 'string',
                description:
                  "Conteúdo do bloco conforme o tipo: (texto/citacao/destaque) texto literal em parágrafos; (titulo/subtitulo) cabeçalho interno do conteúdo, nunca a identificação da questão; (lista) itens em linhas separadas; (equacao) somente expressão em LaTeX; (codigo) somente o código; (imagem) descrição visual curta (alt-text) sem OCR; (separador) pode ser vazio; (fonte) créditos/referência exibível (ex: 'Fonte: ...', 'Adaptado de ...', autor/obra/URL); (tabela) use formato Markdown Table (para tabelas simples) ou HTML <table> (para tabelas complexas com mesclagem/colspan/rowspan).",
              },
            },
            required: ['tipo', 'conteudo'],
          },
