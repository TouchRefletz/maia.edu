  ...
  switch (tipo) {
    ...
    case 'codigo':
      ...
      return React.createElement(
        ...
        React.createElement(
          'code',
          { className: block.props?.language ? `language-${block.props.language}` : '' },
          conteudoRaw,
        ),
      );
    case 'separador':
    ...
    case 'questao': {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('span', null, `Buscando questão: ${conteudoRaw}...`),
        ),
      );
    }
    case 'scaffolding': {
...
const ChatLayoutRenderer = ({ data }) => {
  ...
  if (layoutId === 'linear' || (!slots && conteudo)) {
    ...
    const blocksToRender = layoutId === 'linear' && slots?.content ? slots.content : conteudo || [];
    return React.createElement(
      'div',
          ...
          React.createElement(
            ...
            slides.map((blockOrSlide, idx) => {
              ...
              if (
                ...
                (Array.isArray(blockOrSlide.content) || Array.isArray(blockOrSlide.conteudo))
              ) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'span',
          { className: 'chat-sources-label' },
          `${sources.length} fontes pesquisadas`,
        ),
      ),
    ),
  );
...
export const generateChatHtmlString = (data) => {
  ...
  if (data?.sections && Array.isArray(data.sections)) {
    ...
    return html.replace(/data-onclick="/g, 'onclick="').replace(/data-onerror="/g, 'onerror="');
  }
