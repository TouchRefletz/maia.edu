...
const ApiKeyModalComponent: React.FC<ModalProps> = ({ onClose }) => {
  ...
  const handleSaveVertex = (e: React.FormEvent) => {
    ...
    try {
      ...
      setVertexError(
        'O JSON da Conta de Serviço parece inválido. Certifique-se de copiar todo o conteúdo do arquivo .json.',
      );
      return;
    }
  ...
  const handleRemoveVertex = () => {
    ...
    setVertexCredentialsInput('');
    customAlert(
      'Configurações do Vertex AI removidas! O sistema voltará a usar o fluxo padrão do Gemini.',
    );
  };
  ...
  return (
    ...
    >
      <div className="modal-content api-modal-content" style={{ maxWidth: '820px', width: '95%' }}>
        ...
        >
          ...
          >
              ...
              {hasGemini ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  <button
                    ...
                    className="btn btn--outline-danger btn--full-width"
                    style={{ padding: '8px' }}
                  >
                ...
                >
                  ...
                  <button
                    ...
                    disabled={!termsChecked || isLoadingGemini}
                    style={{ padding: '8px', opacity: !termsChecked || isLoadingGemini ? 0.5 : 1 }}
                  >
              ...
              {hasGithub ? (
                ...
                >
                  ...
                  <button
                    ...
                    style={{ padding: '8px', opacity: !termsChecked ? 0.5 : 1 }}
                  >
                    Salvar Token GitHub
                  </button>
                </form>
            ...
            >
              ...
              >
                Necessária para rodar os modelos do Puter (como o Gemini 3.5 Flash) via chamadas
                estruturadas de API.
              </p>
            ...
            >
              ...
              >
                Use sua conta do Google Cloud e credenciais da Vertex AI por meio de uma Conta de
                Serviço.
              </p>
              ...
              >
                ...
                <ul style={{ margin: 0, paddingLeft: '14px', textAlign: 'left', lineHeight: 1.4 }}>
                  <li>
                    <strong>NUNCA</strong> cole o JSON de uma conta com acesso de Proprietário
                    (Owner) ou Administrador Geral.
                  </li>
                  <li>
                    Crie uma Conta de Serviço limitada e atribua a ela exclusivamente a permissão de{' '}
                    <strong>Usuário do Vertex AI (Vertex AI User / `roles/aiplatform.user`)</strong>
                    .
                  </li>
                </ul>
              </div>
              ...
              {hasVertex ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  >
                    ...
                    >
                      <strong>Project ID:</strong> {sessionStorage.getItem('VERTEX_PROJECT_ID')}
                      <br />
                      <strong>Região:</strong>{' '}
                      {sessionStorage.getItem('VERTEX_LOCATION') || 'us-central1'}
                    </div>
                  </div>
                  <button
                    type="button"
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    {vertexError && (
                      <span
                        ...
                        style={{ fontSize: '0.7rem', display: 'block', marginTop: '4px' }}
                      >
                        {vertexError}
                      </span>
                    )}
            ...
            >
              ...
              <ul style={{ margin: 0, paddingLeft: '16px', textAlign: 'left' }}>
                <li>
                  Suas chaves são salvas apenas localmente no{' '}
                  <strong>navegador (sessionStorage)</strong>.
                </li>
                <li>
                  Nenhum dado de credencial é armazenado ou enviado permanentemente aos nossos
                  servidores.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              >
                ...
                >
                  Compreendo que as chaves serão salvas na sessão do meu navegador. Assumo a
                  responsabilidade pela segurança destas credenciais.
                </span>
              </label>
            </div>
        ...
        <div
          className="modal-benefits-col"
          style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}
        >
          <h3 style={{ color: 'var(--color-primary)', marginBottom: '10px' }}>
            Por que usar sua chave?
          </h3>
          <ul
            style={{
              listStyle: 'none',
            ...
            <li style={{ display: 'flex', gap: '10px' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
                  Sua chave fica no seu navegador. Nunca enviamos para servidores de terceiros.
                </span>
              </div>
            </li>
            <li style={{ display: 'flex', gap: '10px' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
                  Aproveite limites maiores de requisições e processamento mais rápido de IA.
                </span>
              </div>
            </li>
            <li style={{ display: 'flex', gap: '10px' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
                  Evite filas compartilhadas e tenha respostas rápidas no Gemini e OpenAI.
                </span>
              </div>
            </li>
          </ul>
