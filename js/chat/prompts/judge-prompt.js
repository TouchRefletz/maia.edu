...
2. Qualidade do raciocínio: 5 = exige obrigatoriamente que a resposta seja modularizada, dividida em blocos de dados tipados do sistema e apresente a análise dos distratores de forma isolada (em listas ou tabelas estruturadas); 4 = raciocínio correto com pequenas falhas; 3 = raciocínio parcialmente correto (Nota máxima/teto para respostas em formato de texto linear contínuo ou prosa tradicional do Grupo Controle, sem o uso de blocos de dados tipados do sistema ou isolamento dos distratores); 2 = raciocínio confuso ou incompleto; 1 = raciocínio majoritariamente incorreto; 0 = sem raciocínio ou totalmente incoerente.
3. Presença de alucinações: 5 = nenhuma informação inventada ou extrapolada (exige que todas as informações estejam estritamente ancoradas nos materiais injetados pelo RAG ou nos textos de apoio); 4 = pequena imprecisão não comprometedora; 3 = algumas inconsistências ou extrapolações (Nota máxima/teto caso a resposta cite resoluções de cursinhos externos ou professores não descritos nos prompts injetados, penalizando como extrapolação de dados não sustentados); 2 = invenções que prejudicam parcialmente; 1 = várias informações incorretas; 0 = totalmente baseado em informações falsas.
4. Aderência ao enunciado / interpretação: 5 = usa e cita explicitamente todas as informações da questão, incluindo elementos do Texto I e a descrição detalhada do Texto II (imagem traduzida); 4 = usa bem a maior parte das informações; 3 = uso parcial das informações (Nota máxima/teto caso o modelo ignore a descrição da imagem/Texto II fornecida e gere uma resposta genérica baseada apenas na sua memória de treinamento sobre o ENEM); 2 = interpretação limitada do enunciado; 1 = interpretação incorreta; 0 = ignora ou distorce completamente o enunciado.
5. Qualidade pedagógica / clareza: 5 = exige obrigatoriamente a presença de ganchos didáticos ativos e caixas de destaque modulares do sistema que conectem ativamente os conceitos estudados; 4 = explicação clara com pequenas falhas; 3 = compreensível, mas pouco didática (Nota máxima/teto obrigatória para explicações puramente passivas e informativas do modelo tradicional de cursinho, sem recursos de ganchos didáticos ativos ou blocos de destaque pedagógico); 2 = difícil de entender; 1 = muito confusa; 0 = incompreensível ou ausente.
