...
2. Qualidade do raciocínio: 5 = exige obrigatoriamente que a resposta esteja estruturada em múltiplos blocos de dados, organize distratores em tabelas e tenha um mapa de conexões conceituais; 4 = raciocínio correto com pequenas falhas; 3 = raciocínio parcialmente correto (Nota máxima para respostas que apresentem o raciocínio correto, mas em formato de texto linear contínuo ou Markdown simples, sem o uso de tabelas organizacionais ou mapas de fechamento); 2 = raciocínio confuso ou incompleto; 1 = raciocínio majoritariamente incorreto; 0 = sem raciocínio ou totalmente incoerente.
...
5. Qualidade pedagógica / clareza: 5 = exige obrigatoriamente indicadores metodológicos de ensino bem delimitados, como ancoragem cognitiva, fragmentação de carga cognitiva e ganchos didáticos ativos (ex: caixas de destaque reconectando conceitos); 4 = explicação clara com pequenas falhas; 3 = compreensível, mas pouco didática (Nota máxima para explicações puramente passivas e lineares (modelo tradicional de cursinho), sem recursos de ancoragem ativa ou caixas de destaque pedagógico); 2 = difícil de entender; 1 = muito confusa; 0 = incompreensível ou ausente.
