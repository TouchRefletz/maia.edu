...
export class LogTranslator {
  static translate(text) {
    ...
    if (t.includes("Runner Image Provisioner"))
      return {
        text: "⚙️ Provisionando infraestrutura isolada de execução...",
        type: "system",
      };
    if (t.includes("Operating System") && t.includes("Ubuntu"))
      return {
        text: "🖥️ Configurando sistema operacional (Ubuntu Linux)...",
        type: "system",
      };
    ...
    if (t.includes("Pulling fs layer"))
      return {
        text: "⬇️ Baixando camadas da imagem Docker (Sistema de Arquivos)...",
        type: "loading",
      };
    if (t.includes("Verifying Checksum"))
      return {
        text: "🛡️ Verificando integridade dos pacotes baixados...",
        type: "loading",
      };
    ...
    if (t.includes("Connected to server with tools"))
      return {
        text: "🛠️ Ferramentas conectadas com sucesso (Browser, Code, Search).",
        type: "success",
      };
    ...
    if (t.includes("curl") || t.includes("wget"))
      return {
        text: "⬇️ Realizando download de recursos identificados...",
        type: "in_progress",
      };
