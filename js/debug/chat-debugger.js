...
const SCENARIOS = {
    ...
    data: {
      ...
      slots: {
        ...
        right: [
          ...
          createQuote('A tendência de alta é confirmada pela média móvel de 7 dias.'),
    ...
    data: {
      ...
      slots: {
        sidebar: [
          ...
          createList(['Introdução', '**Autenticação**', 'Endpoints', 'Erros Comuns']),
          createSeparator(),
        ...
        main: [
          ...
          createText('A autenticação é feita via **Bearer Token** no header de cada requisição.'),
          createCode(
  ...
  -H "Authorization: Bearer <seu_token>"`,
          ...
          createImage('Fluxo OAuth2', 'https://via.placeholder.com/800x300.png?text=OAuth2+Flow'),
        ],
      },
    },
  },
    ...
    data: {
      ...
      slots: {
        ...
        feed: [
          ...
          createText('**SpaceX:** Teste de ignição estática bem sucedido no Texas.'),
          createSeparator(),
          createText('**ESA:** Agência Europeia anuncia novos astronautas para 2026.'),
          createSeparator(),
          createText('**Blue Origin:** Novo foguete New Glenn chega à plataforma.'),
        ],
      },
    },
  },
    ...
    data: {
      ...
      slots: {
        ...
        col3: [
          ...
          createList(['SSO', 'SLA Garantido', 'Gerente de Conta', 'Audit Logs']),
    ...
    data: {
      ...
      slots: {
        ...
        sidebar: [
          ...
          createList(['US-East-1 (Active)', 'EU-West-2 (Active)', 'SA-East-1 (Warning)']),
          createSeparator(),
    ...
    data: {
      ...
      slots: {
        ...
        step_3: [
          ...
          createText('A conversão ocorre. O onboarding deve ser imediato e sem atritos.'),
    ...
    data: {
      ...
      slots: {
        ...
        content: [
          ...
          createText('Nesta aula vamos desmistificar como as CNNs processam imagens.'),
          createSubtitle('Tópicos Abordados'),
          createList(['Camadas de Convolução', 'Pooling', 'Flattening', 'Full Connection']),
    ...
    data: {
      ...
      slots: {
        content: [
          ...
          createHighlight('Responda a este passo para liberar a explicação e avançar.', '🤖'),
        ],
      },
    },
  },
