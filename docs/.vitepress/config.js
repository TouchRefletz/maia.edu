...
export default withMermaid(
  defineConfig({
    title: 'maia.edu — Docs',
    description: 'Documentação técnica exaustiva da plataforma educacional maia.edu',
    lang: 'pt-BR',
    base: '/docs/',
    ...
    head: [
      ...
      [
        ...
        {
          name: 'keywords',
          content: 'maia.edu, documentação, IA educacional, vestibular, ENEM, Gemini, PDF viewer',
        },
      ],
    ],
    ...
    themeConfig: {
      ...
      sidebar: [
        ...
        // SEÇÃO 1 — INFRAESTRUTURA, CI/CD E BUILD
        {
          ...
          items: [
            ...
            { text: 'Linters e Qualidade (Biome & Sonar)', link: '/infra/linter-quality' },
            { text: 'Suíte de Scripts Utilitários', link: '/infra/scripts-utilitarios' },
        ...
        // SEÇÃO 2 — MAIA API WORKER
        {
          ...
          items: [
            ...
            { text: '/delete-pinecone-record e /clear', link: '/api-worker/pinecone-crud' },
            { text: '/trigger-deep-search', link: '/api-worker/deep-search' },
            { text: '/deep-search-cache e /cancel', link: '/api-worker/deep-search-cache' },
            ...
            { text: '/resolve-link e /check-duplicate', link: '/api-worker/utils-endpoints' },
          ],
        },
        ...
        // SEÇÃO 3 — MOTOR DE IA E CHAT
        {
          ...
          items: [
            ...
            { text: 'Pipelines de Benchmark', link: '/chat/benchmark-eval' },
        ...
        // SEÇÃO NOVA — EDITOR DE QUESTÕES
        {
          text: '✏️ Editor de Questões',
          collapsed: true,
          items: [{ text: 'Visão Geral do Editor', link: '/editor/visao-geral' }],
        },
      ...
      socialLinks: [{ icon: 'github', link: 'https://github.com/TouchRefletz/maia.edu' }],
      ...
      footer: {
        message: '🤖 Documentação gerada por IA — Reporte erros via GitHub Issues',
        copyright: '© 2024-2026 maia.edu — Todos os direitos reservados',
      },

      editLink: {
        pattern: 'https://github.com/TouchRefletz/maia.edu/edit/main/docs/:path',
